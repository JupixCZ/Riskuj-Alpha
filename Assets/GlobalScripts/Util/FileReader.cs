...
public static class FileReader
{
    ...
    public static List<Question> GetThirdRoundQuestions()
    {
        processedString = wholeFileString;

        processedString = TrimUntil(processedString, "[TRETI_KOLO]");
        ...
        for (int i = 1; i < 10; i++)
        {
            ...
            Question question = GetThirdRoundQuestion(code, processedString);
            questions.Add(question);
        }
    ...
    private static Question GetThirdRoundQuestion(string code, string processedString)
    {
        int prize = Convert.ToInt32(code) * 1000;

        processedString = TrimUntil(processedString, "[" + code + "]=");
        string text = GetQuestionText(processedString);
        bool ingot = IsQuestionIngot(text);
